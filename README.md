...
**If you want to download the tool without changing the source code (Windows only), go to the "Releases" panel on the right, download the latest release, and unzip it. Then double click on the .exe file with a "fox" head.**
